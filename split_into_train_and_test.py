...
path_to_input_images = os.path.join(path_to_dataset, "tmp_data/input_images")

# Define the path to the ground truth images folder
path_to_ground_truth_images = os.path.join(path_to_dataset, "tmp_data/ground_truth_images")
