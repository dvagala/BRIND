...
input_dir = 'train_imgs/imgs_all'
ground_truth_dir = 'train_gt/gt_all'
output_dir = 'train_imgs/imgs_all'
ground_truth_output_dir = 'train_gt/gt_all'
...
for filename in os.listdir(input_dir):
    if filename.endswith('.jpg') or filename.endswith('.jpeg'):
        ...
        with Image.open(input_path) as original_img, Image.open(ground_truth_path) as original_gt_img:
            ...
            for i in range(args.aug_number_per_image):
                img = original_img
